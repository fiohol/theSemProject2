                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <p class="text-muted font-13 m-b-30">
                                            ...
                                            <c:url var="addAction" value="/controller/administration/doPwdChange"></c:url>
                                            <form:form action="${addAction}" commandName="SemServerPwd" class="form-horizontal form-label-left" method="POST">
                                            ...
                                            <div class="form-group">
                                                <form:label path="old" class="control-label col-md-3 col-sm-3 col-xs-12">
                                                    Vecchia password
                                                </form:label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <form:password path="old" class="form-control col-md-7 col-xs-12"/>
                                                        <form:errors path="old" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <form:label path="new1" class="control-label col-md-3 col-sm-3 col-xs-12">
                                                    Nuova password
                                                </form:label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <form:password path="new1" class="form-control col-md-7 col-xs-12"/>
                                                    <form:errors path="new1" />
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <form:label path="new2" class="control-label col-md-3 col-sm-3 col-xs-12">
                                                    Ripeti password
                                                </form:label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <form:password path="new2" class="form-control col-md-7 col-xs-12" />
                                                    <form:errors path="new2" />
                                                </div>
                                            </div>



                                                <input type="submit" value="Modifica password" class="btn btn-success"/> <br><br>
